...
Row {
   ...
   // property bool darkMode: false
    ...
    // Note: selectedSubredditChanged signal is automatically generated for the property
    ...
    OptionSelector {
        ...
        onSelectedIndexChanged: {
            if (root.categoryNames.length > 0 && selectedIndex >= 0) {
                ...
                // The selectedSubredditChanged signal is automatically emitted when the property changes
                if (root.memeFetcher) {
